...
static int cunnx_NoisyReLU_updateOutput(lua_State *L)
{
...
static int cunnx_NoisyReLU_updateGradInput(lua_State *L)
{
  THCudaTensor *output = (THCudaTensor*)luaT_getfieldcheckudata(L, 1, "output", "torch.CudaTensor");
  THCudaTensor *input = (THCudaTensor*)luaT_checkudata(L, 2, "torch.CudaTensor");
...
static const struct luaL_Reg cunnx_NoisyReLU__ [] = {
  {"NoisyReLU_updateOutput", cunnx_NoisyReLU_updateOutput},
  {"NoisyReLU_updateGradInput", cunnx_NoisyReLU_updateGradInput},
  {NULL, NULL}
};
